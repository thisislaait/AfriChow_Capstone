    ...
    <div className='px-10 py-6 bg-green-200 text-white flex justify-between items-center top-0 right-0 left-0 z-10 bg-transparent'>
      ...
      {menuOpen && (
        <div className='absolute top-8 left-16 cursor-pointer flex items-center gap-20' >
          <div className='h-3 w-10 py-2 pr-4 flex justify-center items-center gap-3 fixed z-30' >
      ...
      {menuOpen && (
        <div className='fixed top-0 left-0 right-16 bottom-0 pt-8 bg-lime-100 text-black flex flex-col justify-center items-start gap-3 z-20 pl-7'>
          ...
          <div className='mt-auto p-12 flex items-center justify-center gap-8'>
            <p id='subscribe' className='text-sm font-semibold pl-4'>Join Our Mailing List</p>
            <form>
