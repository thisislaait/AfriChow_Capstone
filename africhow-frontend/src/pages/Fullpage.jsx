...
const Fullpage = () => {
  return (
    <div className='fullscreen bkground lg:block md:block h-screen w-screen hidden overflow-hidden'>
        ...
        <section className=' h-screen flex flex-col justify-center px-12'>
            ...
            <a href="#" className='px-8 py-3 bg-lime-300 w-40 mt-3 text-sm font-bold'>Get Started</a>
