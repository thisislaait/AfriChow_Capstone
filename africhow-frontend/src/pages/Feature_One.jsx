...
const Feature_One = () => {
  ...
  return (
    <div className='lg:hidden w-full min-h-full bg-opacity-25'>
                  ...
                  <div className='flex w-full gap-3'>
                    ...
                    <div className='flex justify-between items-center border mb-8 w-1/2 shadow-lg rounded-md pr-3 bg-black'>
                        <div className='flex items-center gap-2 px-4'>
                          <img src= {Meal} alt="" srcset="" className='w-4 h-4 rounded-full' />
                          <div className='flex flex-col text-left justify-start my-3'>
                            <p className='meal_name font-semibold text-white'>Reo noodles</p>
                            <p className='meal_price font-bold text-gray-400'>N3,200</p>
                          </div>
                        </div>
                        <div>
                          <p className='add_meal px-1 border border-green-800 bg-lime-300'>+</p>
